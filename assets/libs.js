        ...
        var r,
          ...
          i = (function () {
            ...
            var e = {
              ...
              init: function (t) {
                (e.list = t),
                  window.addEventListener("resize", e.poll),
                  window.addEventListener("orientationchange", e.poll),
                  window.addEventListener("load", e.poll),
                  window.addEventListener("fullscreenchange", e.poll);
              },
              active: function (t) {
                var n, r, o, i, a, s, u;
                if (!(t in e.media)) {
                  if (
                    ...
                    if (((i = e.list[n]), Array.isArray(i))) {
                      if (
                        ((a = parseInt(i[0])), (s = parseInt(i[1])), isNaN(a))
                      ) {
                        if (isNaN(s)) return;
                        u = i[1].substr(String(s).length);
                      } else u = i[0].substr(String(a).length);
                      if (isNaN(a))
                        switch (r) {
                          case "gte":
                            o = "screen";
                          ...
                          case "lte":
                          default:
                            o = "screen and (max-width: " + s + u + ")";
                            break;
                          case "gt":
                          case "not":
                            o = "screen and (min-width: " + (s + 1) + u + ")";
                            break;
                          case "lt":
                ...
                return (
                  !1 !== e.media[t] && window.matchMedia(e.media[t]).matches
                );
              },
              on: function (t, n) {
                e.events.push({ query: t, handler: n, state: !1 }),
                  e.active(t) && n();
              },
              poll: function () {
                var t, n;
                for (t = 0; t < e.events.length; t++)
                  (n = e.events[t]),
                    e.active(n.query)
    ...
    "jquery.touch": [
      function (e, t, n) {
        !(function (e) {
          ...
          function a(e, t, n) {
            var r = e[0];
            return void 0 === r._touch && (r._touch = new i(e, t, n)), r._touch;
          }
          function s(e, t, n) {
            var r, o, i;
            return (
              ...
              (i = e.$element.height()),
              {
                ...
                y: Math.min(Math.max(n, r.top), r.top + i),
              }
            );
          }
          (i.prototype.hasOwnProperty = function (e, t) {
            return Object.prototype.hasOwnProperty.call(e, t);
          }),
            (i.prototype.uses = function (t) {
              var n = e._data(this.$sourceElement[0], "events");
              switch (t) {
                case "swipe":
                  return (
                    this.hasOwnProperty(n, t) ||
                    this.hasOwnProperty(n, "swipeUp") ||
                    this.hasOwnProperty(n, "swipeDown") ||
                    this.hasOwnProperty(n, "swipeLeft") ||
                    this.hasOwnProperty(n, "swipeRight")
                  );
                case "drag":
                  return (
                    this.hasOwnProperty(n, t) ||
                    this.hasOwnProperty(n, "dragStart") ||
                    this.hasOwnProperty(n, "dragEnd")
                  );
                case "tapAndHold":
                case "doubleTap":
                  return this.hasOwnProperty(n, t);
                case "tap":
                  return (
                    this.hasOwnProperty(n, t) ||
                    this.hasOwnProperty(n, "doubleTap") ||
                    this.hasOwnProperty(n, "tapAndHold")
                  );
              }
              return !1;
            }),
            ...
            (i.prototype.doStart = function (e, t, n) {
              var r = this,
                o = r.$element.offset();
              e.stopPropagation(),
                ((r.uses("drag") && r.settings.preventDefault.drag(r)) ||
                  (r.uses("swipe") && r.settings.preventDefault.swipe(r)) ||
                  (r.uses("tap") && r.settings.preventDefault.tap(r))) &&
                  e.preventDefault(),
                r.uses("tapAndHold") &&
                  r.$element
                ...
                (r.timerTap = setTimeout(function () {
                  r.inTap &&
                    r.taps > 0 &&
                    (r.$element.trigger(2 == r.taps ? "doubleTap" : "tap", {
                      taps: r.taps,
                      x: r.x,
                      y: r.y,
                      ex: r.ex,
                ...
                r.uses("tapAndHold") &&
                  (clearTimeout(r.timerTapAndHold),
                  (r.timerTapAndHold = setTimeout(function () {
                    r.inTap &&
                      (r.$element.trigger("tapAndHold", {
                        x: r.x,
                        y: r.y,
                        ex: r.ex,
                        ey: r.ey,
            ...
            (i.prototype.doMove = function (o, i, a) {
              var s,
                u = this,
                l = u.$element.offset(),
                c = (Math.abs(u.x - i) + Math.abs(u.y - a)) / 2;
              if (
                (o.stopPropagation(),
                ((u.uses("swipe") && u.settings.preventDefault.swipe(u)) ||
                  (u.uses("drag") && u.settings.preventDefault.drag(u))) &&
                  o.preventDefault(),
                c > 2 && clearTimeout(u.timerTapAndHold),
                u.inDrag && n == u)
              ) {
                if (
                  (u.$element.trigger("drag", {
                    x: i,
                    y: a,
                    ex: i - l.left,
                    ey: a - l.top,
                  ...
                  (s =
                    "fixed" == u.$element.css("position")
                      ? document.elementFromPoint(
                          i - t.scrollLeft(),
                          a - t.scrollTop()
                        )
                      : document.elementFromPoint(i, a)),
                  u.$element.css("pointer-events", ""),
                  s)
                ) {
                  if (!1 !== u.settings.dropFilter)
                    switch (typeof u.settings.dropFilter) {
                      case "string":
                        if (u.settings.dropFilterTraversal)
                          for (; s && !e(s).is(u.settings.dropFilter); )
                            s = s.parentElement;
                        else e(s).is(u.settings.dropFilter) || (s = null);
                        break;
                      case "function":
                        if (u.settings.dropFilterTraversal)
                          for (
                            ;
                            s && !0 !== u.settings.dropFilter(u.$element[0], s);

                          )
                            s = s.parentElement;
                        else
                          !1 === u.settings.dropFilter(u.$element[0], s) &&
                            (s = null);
                        break;
                      default:
                        if (!0 === u.settings.dropFilter)
                          for (
                            ;
                            s.parentElement != u.$element[0].parentElement;
              ...
              } else if (c > u.settings.dragThreshold) {
                ...
                u.cancel(),
                  ...
                  (u.eyStart = a - l.top),
                  u.uses("drag") &&
                    u.settings.preventDefault.drag(u) &&
                    o.preventDefault(),
            ...
            (i.prototype.doEnd = function (t, o, i) {
              var a,
                s,
                u,
                l = this,
              ...
              t.stopPropagation(),
                l.inTap
                  ? (clearTimeout(l.timerTapAndHold),
                    l.taps++,
                    (!l.timerTap ||
                      (1 == l.taps && !l.uses("doubleTap")) ||
                      (2 == l.taps && l.uses("doubleTap"))) &&
                      (l.$element.trigger(2 == l.taps ? "doubleTap" : "tap", {
                        taps: l.taps,
                        x: l.x,
                        y: l.y,
                        ex: l.ex,
                  ...
                  ? (r &&
                      ...
                      (r = null)),
                    (u = Date.now() - l.dragStart),
                    (s =
                      (a = Math.sqrt(
                        Math.pow(Math.abs(l.x - o), 2) +
                          Math.pow(Math.abs(l.y - i), 2)
                      )) / u),
                    l.$element.trigger("dragEnd", {
                      start: { x: l.x, y: l.y, ex: l.ex, ey: l.ey },
                      end: { x: o, y: i, ex: o - c.left, ey: i - c.top },
                      distance: a,
                      duration: u,
                      velocity: s,
                      event: t,
                    ...
                    (n = null),
                    (f > l.settings.swipeThreshold ||
                      d > l.settings.swipeThreshold) &&
                      (l.$element.trigger("swipe", {
                        distance: a,
                        duration: u,
                        velocity: s,
                        event: t,
                  ...
                  : l.inTapAndHold &&
                    (clearTimeout(l.timerTapAndHold),
                    l.$element.trigger("tapAndHoldEnd", {
                      x: l.x,
                      y: l.y,
                      event: t,
                      touch: l,
            ...
            (e.touch = function (n, r) {
              var i = {};
              if (
                ((i = e.extend(i, o)),
                "function" != typeof (i = e.extend(i, r)).preventDefault.drag &&
                  (i.preventDefault.drag =
                    !0 === i.preventDefault.drag
                      ? function (e) {
                          return !0;
                        }
                      : function (e) {
                ...
                "function" != typeof i.preventDefault.swipe &&
                  (i.preventDefault.swipe =
                    !0 === i.preventDefault.swipe
                      ? function (e) {
                          return !0;
                        }
                      : function (e) {
                ...
                "function" != typeof i.preventDefault.tap &&
                  (i.preventDefault.tap =
                    !0 === i.preventDefault.tap
                      ? function (e) {
                          return !0;
                        }
                      : function (e) {
                ...
                var u = function (t) {
                  ...
                  (r.started = !0),
                    r.doStart(
                      t,
                      t.originalEvent.touches[0][i.coordinates + "X"],
                      t.originalEvent.touches[0][i.coordinates + "Y"]
                    ),
                    setTimeout(function () {
                      r.started = !1;
                    }, 1e3);
                ...
                n.on("touchstart", u),
                  i.delegateSelector &&
                    n.on("touchstart", i.delegateSelector, u);
                var l = function (t) {
                  var r = a(e(this), n, i),
                    o = t.originalEvent.touches[0][i.coordinates + "X"],
                    u = t.originalEvent.touches[0][i.coordinates + "Y"];
                  if (
                    r.settings.trackDocument &&
                    r.settings.trackDocumentNormalize
                  ) {
                    var l = s(r, o, u);
                    (o = l.x), (u = l.y);
                  }
                ...
                n.on("touchmove", l),
                  i.delegateSelector &&
                    n.on("touchmove", i.delegateSelector, l);
                var c = function (t) {
                  var r = a(e(this), n, i);
                  r.ended = !0;
                  var o = s(
                    r,
                    t.originalEvent.changedTouches[0][i.coordinates + "X"],
                    t.originalEvent.changedTouches[0][i.coordinates + "Y"]
                  );
                  r.doEnd(t, o.x, o.y),
                    setTimeout(function () {
                      r.ended = !1;
                ...
                n.on("touchend", c),
                  i.delegateSelector && n.on("touchend", i.delegateSelector, c);
              }
              if (i.useMouse) {
                var f = function (t) {
                  var r = a(e(this), n, i);
                ...
                n.on("mousedown", f),
                  i.delegateSelector &&
                    n.on("mousedown", i.delegateSelector, f);
                var d = function (t) {
                  var r = a(e(this), n, i);
                  r.mouseDown &&
                    r.doMove(t, t[i.coordinates + "X"], t[i.coordinates + "Y"]);
                };
                n.on("mousemove", d),
                  i.delegateSelector &&
                    n.on("mousemove", i.delegateSelector, d);
                var p = function (r) {
                  var o = a(e(this), n, i);
                  if (o.ended) return !1;
                  t.triggerHandler("mouseup", r),
                    o.doEnd(r, r[i.coordinates + "X"], r[i.coordinates + "Y"]),
                    (o.mouseDown = !1);
                };
                n.on("mouseup", p),
                  i.delegateSelector && n.on("mouseup", i.delegateSelector, p);
              }
              i.trackDocument ||
                n.on("mouseleave", function (t) {
                  var r = a(e(this), n, i);
                  r.doEnd(t, t[i.coordinates + "X"], t[i.coordinates + "Y"]),
                    (r.mouseDown = !1);
                });
            }),
            t
              .on("mousemove", function (e) {
                ...
                if (
                  ...
                  var r = e[t.settings.coordinates + "X"],
                    o = e[t.settings.coordinates + "Y"];
              ...
              .on("mouseup", function (e, t) {
                ...
                if (r && r.settings.useMouse && r.settings.trackDocument) {
                  if (
                    (void 0 !== t && (e = t),
                    !(r.settings.coordinates + "X" in e))
                  )
                    return;
                  var o = e[r.settings.coordinates + "X"],
                    i = e[r.settings.coordinates + "Y"];
                  if (r.settings.trackDocumentNormalize) {
                    var a = s(r, o, i);
                    (o = a.x), (i = a.y);
                  }
                  r.doEnd(e, o, i), (r.mouseDown = !1);
                }
              });
        })(jQuery);
      },
        ...
        !(function (e, n) {
                    ...
                    for (t in e)
                      (r = e[t]),
                        "__proto__" !== t &&
                          ...
                          (l &&
                          r &&
                          (w.isPlainObject(r) || (o = Array.isArray(r)))
                            ? ((n = a[t]),
                              (i =
                                o && !Array.isArray(n)
                                  ? []
            ...
            function Se(e, t, n, r, o, i) {
              return (
                ...
                le(function (i, a, s, u) {
                  ...
                  } else (v = Te(v === a ? v.splice(h, v.length) : v)), o ? o(null, a, v, u) : q.apply(a, v);
                })
              );
            }
            function Ae(e) {
              ...
              function (e, t) {
                w.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (q[e] || w.uniqueSort(o), $.test(e) && o.reverse()),
                    this.pushStack(o)
                  );
                };
              }
            ...
            w.extend({
              ...
              ready: function (e) {
                (!0 === e ? --w.readyWait : w.isReady) ||
                  ((w.isReady = !0),
                  (!0 !== e && --w.readyWait > 0) || z.resolveWith(m, [w]));
              },
            }),
            (w.ready.then = z.then),
                ...
                for (
                  ...
                  for (
                    ...
                    (u.rnamespace &&
                      ...
                      void 0 !==
                        (r = (
                          (w.event.special[i.origType] || {}).handle ||
                          i.handler
                        ).apply(o.elem, s)) &&
                        !1 === (u.result = r) &&
          ...
          function qe(e, t) {
            ...
            if (1 === t.nodeType) {
              ...
              G.hasData(e) &&
                ((i = G.access(e)), (a = w.extend({}, i)), G.set(t, a));
            }
          }
          function He(e, t) {
            var n = t.nodeName.toLowerCase();
          ...
          function Me(e, t, n, r) {
            ...
            if (
              v ||
              (d > 1 && "string" == typeof m && !p.checkClone && Ee.test(m))
            )
            ...
            if (
              ...
              for (u = (s = w.map(ve(o, "script"), Le)).length; f < d; f++)
                (l = o),
                  f !== g &&
                    ((l = w.clone(l, !0, !0)),
              ...
              if (u)
                for (
                  c = s[s.length - 1].ownerDocument, w.map(s, $e), f = 0;
                  f < u;
                  f++
                )
                  (l = s[f]),
          ...
          w.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (t)
                if (n)
                  for (
                    i = i || ve(e), a = a || ve(s), r = 0, o = i.length;
                    r < o;
                    r++
                  )
                    qe(i[r], a[r]);
            ...
            cleanData: function (e) {
              for (
                var t, n, r, o = w.event.special, i = 0;
                void 0 !== (n = e[i]);
                i++
              )
                if (Z(n)) {
            ...
            w.each(
              ...
              function (e, t) {
                w.fn[e] = function (e) {
                  for (
                    var n, r = [], o = w(e), i = o.length - 1, s = 0;
                    s <= i;
                    s++
                  )
          ...
          function Qe(e, t, n, r, o, i) {
            ...
            for (; a < 4; a += 2)
              "margin" === n && (u += w.css(e, n + ne[a], !0, o)),
                r
                  ? ("content" === n &&
                      (u -= w.css(e, "padding" + ne[a], !0, o)),
                    "margin" !== n &&
                      (u -= w.css(e, "border" + ne[a] + "Width", !0, o)))
                  : ((u += w.css(e, "padding" + ne[a], !0, o)),
                    "padding" !== n
                      ? (u += w.css(e, "border" + ne[a] + "Width", !0, o))
              ...
              w.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                  var o,
                    ...
                    s =
                      (a || r) && "border-box" === w.css(e, "boxSizing", !1, i),
                    u = r ? Qe(e, t, r, s, i) : 0;
                  return (
                    s &&
                      a &&
            ...
            w.extend({
              valHooks: {
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      var n, r, o = e.options, i = w.makeArray(t), a = o.length;
                      a--;

                    )
                      ((r = o[a]).selected =
                        w.inArray(w.valHooks.option.get(r), i) > -1) &&
                        (n = !0);
          ...
          (Pt.href = bt.href),
            w.extend({
              ...
              ajax: function (t, n) {
                ...
                p.ifModified &&
                  (w.lastModified[o] &&
                    A.setRequestHeader("If-Modified-Since", w.lastModified[o]),
                  w.etag[o] && A.setRequestHeader("If-None-Match", w.etag[o])),
                ...
                if (
                  ...
                  if (
                    ((A.readyState = 1), c && g.trigger("ajaxSend", [A, p]), l)
                  )
                    return A;
                  p.async &&
                    p.timeout > 0 &&
                    ...
                    f
                      ? (p.ifModified &&
                          ((T = A.getResponseHeader("Last-Modified")) &&
                            (w.lastModified[o] = T),
                          (T = A.getResponseHeader("etag")) && (w.etag[o] = T)),
                        204 === t || "HEAD" === p.type
                          ? (S = "nocontent")
                          : 304 === t
                          ? (S = "notmodified")
                          : ((S = b.state), (d = b.data), (f = !(m = b.error))))
                      : ((m = S),
                        (!t && S) || ((S = "error"), t < 0 && (t = 0))),
                    (A.status = t),
                    (A.statusText = (n || S) + ""),
                    f
                      ? v.resolveWith(h, [d, S, A])
                      : v.rejectWith(h, [A, S, m]),
                    A.statusCode(x),
                    (x = void 0),
                    c &&
          ...
          w.ajaxSetup({
            ...
            w.each(["top", "left"], function (e, t) {
              w.cssHooks[t] = _e(p.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ie(e, t)), Pe.test(n) ? w(e).position()[t] + "px" : n
                  );
              });
            }),
      ...
      function (e, t, n) {
        ...
        function l(e, t) {
          ...
          for (n = 0; n < e.length; n += 16)
            (o = d),
              ...
              (c = h),
              (f = g),
              (d = i(d, p, h, g, e[n], 7, -680876936)),
              (g = i(g, d, p, h, e[n + 1], 12, -389564586)),
              (h = i(h, g, d, p, e[n + 2], 17, 606105819)),
              (p = i(p, h, g, d, e[n + 3], 22, -1044525330)),
              (d = i(d, p, h, g, e[n + 4], 7, -176418897)),
              (g = i(g, d, p, h, e[n + 5], 12, 1200080426)),
              (h = i(h, g, d, p, e[n + 6], 17, -1473231341)),
              (p = i(p, h, g, d, e[n + 7], 22, -45705983)),
              (d = i(d, p, h, g, e[n + 8], 7, 1770035416)),
              (g = i(g, d, p, h, e[n + 9], 12, -1958414417)),
              (h = i(h, g, d, p, e[n + 10], 17, -42063)),
              (p = i(p, h, g, d, e[n + 11], 22, -1990404162)),
              (d = i(d, p, h, g, e[n + 12], 7, 1804603682)),
              (g = i(g, d, p, h, e[n + 13], 12, -40341101)),
              (h = i(h, g, d, p, e[n + 14], 17, -1502002290)),
              (d = a(
                d,
                (p = i(p, h, g, d, e[n + 15], 22, 1236535329)),
                h,
                g,
                e[n + 1],
                5,
              ...
              (g = a(g, d, p, h, e[n + 6], 9, -1069501632)),
              (h = a(h, g, d, p, e[n + 11], 14, 643717713)),
              (p = a(p, h, g, d, e[n], 20, -373897302)),
              (d = a(d, p, h, g, e[n + 5], 5, -701558691)),
              (g = a(g, d, p, h, e[n + 10], 9, 38016083)),
              (h = a(h, g, d, p, e[n + 15], 14, -660478335)),
              (p = a(p, h, g, d, e[n + 4], 20, -405537848)),
              (d = a(d, p, h, g, e[n + 9], 5, 568446438)),
              (g = a(g, d, p, h, e[n + 14], 9, -1019803690)),
              (h = a(h, g, d, p, e[n + 3], 14, -187363961)),
              (p = a(p, h, g, d, e[n + 8], 20, 1163531501)),
              (d = a(d, p, h, g, e[n + 13], 5, -1444681467)),
              (g = a(g, d, p, h, e[n + 2], 9, -51403784)),
              (h = a(h, g, d, p, e[n + 7], 14, 1735328473)),
              (d = s(
                d,
                (p = a(p, h, g, d, e[n + 12], 20, -1926607734)),
                h,
                g,
                e[n + 5],
                4,
              ...
              (g = s(g, d, p, h, e[n + 8], 11, -2022574463)),
              (h = s(h, g, d, p, e[n + 11], 16, 1839030562)),
              (p = s(p, h, g, d, e[n + 14], 23, -35309556)),
              (d = s(d, p, h, g, e[n + 1], 4, -1530992060)),
              (g = s(g, d, p, h, e[n + 4], 11, 1272893353)),
              (h = s(h, g, d, p, e[n + 7], 16, -155497632)),
              (p = s(p, h, g, d, e[n + 10], 23, -1094730640)),
              (d = s(d, p, h, g, e[n + 13], 4, 681279174)),
              (g = s(g, d, p, h, e[n], 11, -358537222)),
              (h = s(h, g, d, p, e[n + 3], 16, -722521979)),
              (p = s(p, h, g, d, e[n + 6], 23, 76029189)),
              (d = s(d, p, h, g, e[n + 9], 4, -640364487)),
              (g = s(g, d, p, h, e[n + 12], 11, -421815835)),
              (h = s(h, g, d, p, e[n + 15], 16, 530742520)),
              (d = u(
                d,
                (p = s(p, h, g, d, e[n + 2], 23, -995338651)),
                h,
                g,
                e[n],
                6,
              ...
              (g = u(g, d, p, h, e[n + 7], 10, 1126891415)),
              (h = u(h, g, d, p, e[n + 14], 15, -1416354905)),
              (p = u(p, h, g, d, e[n + 5], 21, -57434055)),
              (d = u(d, p, h, g, e[n + 12], 6, 1700485571)),
              (g = u(g, d, p, h, e[n + 3], 10, -1894986606)),
              (h = u(h, g, d, p, e[n + 10], 15, -1051523)),
              (p = u(p, h, g, d, e[n + 1], 21, -2054922799)),
              (d = u(d, p, h, g, e[n + 8], 6, 1873313359)),
              (g = u(g, d, p, h, e[n + 15], 10, -30611744)),
              (h = u(h, g, d, p, e[n + 6], 15, -1560198380)),
              (p = u(p, h, g, d, e[n + 13], 21, 1309151649)),
              (d = u(d, p, h, g, e[n + 4], 6, -145523070)),
              (g = u(g, d, p, h, e[n + 11], 10, -1120210379)),
              (h = u(h, g, d, p, e[n + 2], 15, 718787259)),
              (p = u(p, h, g, d, e[n + 9], 21, -343485551)),
              (d = r(d, o)),
              (p = r(p, l)),
              (h = r(h, c)),
              (g = r(g, f));
        ...
        function g(e, t) {
          return (function (e, t) {
            ...
            return (
              (r = l(i.concat(f(t)), 512 + 8 * t.length)),
              c(l(a.concat(r), 640))
            );
          })(p(e), p(t));
        }
          ...
          i = (function () {
            (String.prototype.capitalize = function () {
              ...
              (String.prototype.camelize = function () {
                var e,
                  t = this.split("-"),
                  n = [];
                for (n.push(t[0].toLowerCase()), e = 1; e < t.length; e++)
                  n.push(t[e].capitalize());
                return n.join("");
              }),
              (Array.countValues = function (e) {
                var t,
                  n = [];
            ...
            var e = {
              types: {
                ...
                emailname:
                  "^([ a-zA-Z0-9\\_\\-\\.\\+ÀÈÌÒÙàèìòùÁÉÍÓÚÝáéíóúýÂÊÎÔÛâêîôûÃÑÕãñõÄËÏÖÜäëïöüçÇßØøÅåÆæÞþÐð\\-\\'\\\"]+) <([a-zA-Z0-9][a-zA-Z0-9\\_\\-\\.\\+]*)@([a-zA-Z0-9\\-\\.]+)\\.([a-zA-Z]+)>$",
                tel: "^[0-9\\-\\+\\(\\)\\ \\#\\*]+$",
                float: "^-?([0-9]+)(\\.([0-9]+)){0,1}$",
                id: "^[a-z0-9\\-]+$",
                recordid: "^[0-9]{16}$",
                ...
                tel: "^[0-9\\-\\+\\(\\)\\s]+$",
                title:
                  "^[a-zA-ZÀÈÌÒÙàèìòùÁÉÍÓÚÝáéíóúýÂÊÎÔÛâêîôûÃÑÕãñõÄËÏÖÜäëïöüçÇßØøÅåÆæÞþÐð0-9\\_\\-\\\\\"\\'\\ \\?\\!\\.\\,\\:\\;\\(\\)\\/\\#\\&\\@\\$\\%\\*\\+\\=]+$",
              ...
              cookie: function (e, t, n, r) {
                if ("" === t)
                  return (
                    r || (r = "/"),
                    (document.cookie =
                      e + "=; expires=Thu, 1 Jan 1970 12:00:00 UTC; path=" + r),
                    null
                  );
                var o, i;
                if (t)
                  return (
                    n || (n = 0),
                    (o = new Date()).setTime(o.getTime() + n),
                    (i = o.toGMTString()),
                    r || (r = "/"),
                    (document.cookie =
                      e + "=" + t + "; expires=" + i + "; path=" + r),
                    t
                  );
                var a,
                  u = document.cookie.split(";");
                for (s in u)
                  if ((a = u[s].split("="))[0].trim() == e)
                    return unescape(a[1]);
                return null;
              },
              ...
              is: function (t, n) {
                return (
                  ...
                  ("function" == typeof t
                    ? t(n)
                    : !e.types[t] || !!n.match(new RegExp(e.types[t])))
                );
              },
              ...
              fieldValue: function (e, t, n) {
                ...
                return "checkbox" ==
                  (r =
                    "#" == t[0]
                      ? e.find(t)
                      : e.find('[name="' + t + '"]')).attr("type")
                  ? (n && r.prop("checked", n).trigger("change"),
                    r.prop("checked"))
                  : "radio" == r.attr("type")
                  ? (n &&
                      r
                        ...
                        .prop("checked", !0)
                        .trigger("change"),
                    null == (o = r.filter(":checked").val()) && (o = ""),
                    o)
                  : ((n || "" === n) && r.val(n).trigger("change"),
                    null == (o = r.val()) && (o = ""),
                    o);
              },
              scrollTo: function (e, t, n) {
                ...
                return (
                  ...
                  (r = Math.max(
                    0,
                    e.offset().top - (o.height() - e.outerHeight()) / 2
                  )),
                  Math.abs(r - o.scrollTop()) < 50
                    ? (n.scrollTop(r), t && t())
                    : n.stop().animate({ scrollTop: r }, 750, "swing", t),
                  !0
                );
              },
              friendlyfy: function (e) {
                return (e = (e = (e = (e = (e = (e = (e = (e = (e =
                  e.toLowerCase()).replace(" & ", " and ")).replace(
                  /([a-zA-Z0-9])\.([a-z]+)/g,
                  "$1 dot $2"
              ...
              date: {
                ...
                offset: function (t) {
                  return (
                    void 0 !== t && (e.date.offsetValue = parseInt(t)),
                    e.date.offsetValue
                  );
                },
                timestamp: function () {
                ...
                absolute: function (t, n) {
                  ...
                  switch (
                    (d.setTime(1e3 * t),
                    (r = e.date.months[d.getMonth()]),
                    (o = d.getDate()),
                    (i = d.getFullYear()),
                    (a = d.getHours()),
                    (s = d.getMinutes()),
                    (u = d.getSeconds()),
                    (l = e.date.days[d.getDay()]),
                    a > 12 ? ((c = a - 12), (f = "pm")) : ((c = a), (f = "am")),
                    n)
                  ) {
                    case 1:
                      p = r + " " + o + ", " + i;
                ...
                relative: function (t, n, r) {
                  ...
                  if (o < 60)
                    switch (n) {
                      case 1:
                        if (o < 30) return "just now";
                        if (o < 60) return "about a minute" + c;
                      case 2:
                        return o + " second" + (1 != o ? "s" : "") + c;
                      default:
                        return o + " secs" + c;
                    }
                  if (o < 3600)
                    switch (
                      ((o -= 60 * (a = Math.floor(o / 60))), (seconds = o), n)
                    ) {
                      case 1:
                  ...
                  if (o < 86400)
                    return 0 === (o -= 3600 * (i = Math.floor(o / 3600)))
                      ? i + " hrs" + c
                      : ((a = Math.floor(o / 60)),
                        2 === n
                          ? i + " hour" + (1 != i ? "s" : "") + c
                  ...
                  if (o < 604800)
                    switch (
                      ((o -= 86400 * (s = Math.floor(o / 86400))),
                      (i = Math.floor(o / 3600)),
                      n)
                    ) {
                      case 1:
                        if (1 == s && i < 6)
                          return f ? "tomorrow" : "yesterday";
                      case 2:
                        return (
                          i > 12 && s++, s + " day" + (1 != s ? "s" : "") + c
                        );
                      default:
                        return s + " days " + i + " hrs" + c;
                    }
                  switch (
                    ((o -= 604800 * (u = Math.floor(o / 604800))),
                    (o -= 86400 * (s = Math.floor(o / 86400))),
                    (i = Math.floor(o / 3600)),
                    n)
                  ) {
                    ...
                    case 2:
                      return (
                        s > 4 && u++,
                        u >= 4
                          ? ((months = Math.floor(u / 4)),
                            months >= 12
                              ? ((years = Math.floor(months / 12)),
                                years + " year" + (1 != years ? "s" : "") + c)
                              : months +
                                " month" +
                                (1 != months ? "s" : "") +
                                c)
